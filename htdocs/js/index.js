...
/***/ function(module, exports, __webpack_require__) {
	...
	var _IndexView = __webpack_require__(2);
	...
	// ページ全体動いてる？
	var view = new _IndexView2.default();
	view.render();
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _baseView = __webpack_require__(85);
	...
	var indexView = function (_BaseView) {
	    (0, _inherits3.default)(indexView, _BaseView);
	
	    function indexView() {
	        (0, _classCallCheck3.default)(this, indexView);
	        return (0, _possibleConstructorReturn3.default)(this, _BaseView.call(this, {
	            el: 'body'
	        }));
	    }
	
	    indexView.prototype.render = function render() {
	        console.log('動いてるよー');
	    };
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _backbone = __webpack_require__(87);
	
	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
	
	// View間のイベント管理用オブジェクト
	var mediator = _underscore2.default.extend({
	    startDate: new Date()
	}, _backbone.Events);
	...
	var BaseView = function (_View) {
	    (0, _inherits3.default)(BaseView, _View);
	
	    function BaseView() {
	        var attributes = arguments.length <= 0 || arguments[0] === undefined ? {} : arguments[0];
	        (0, _classCallCheck3.default)(this, BaseView);
	        return (0, _possibleConstructorReturn3.default)(this, _View.call(this, attributes));
	    }
	
	    (0, _createClass3.default)(BaseView, [{
	        key: 'events',
	        get: function get() {
	            return {};
	        }
...
/***/ function(module, exports, __webpack_require__) {
	...
	(function(factory) {
	  ...
	  if (true) {
	    !(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__(86), __webpack_require__(1), exports], __WEBPACK_AMD_DEFINE_RESULT__ = function(_, $, exports) {
